...
from market.models import ServiceMaterial, Service
...
class ServiceMaterialCreateSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        if service.service_material.filter(material_name=attrs.get('material_name')).exists(): # 역참조 (related_name)
