# Generated by Django 4.0 on 2024-10-29 07:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional_option', models.ManyToManyField(blank=True, related_name='order_additional_option', to='market.ServiceOption')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customer', to='users.user')),
                ('material_name', models.ManyToManyField(blank=True, related_name='order_material_name', to='market.ServiceMaterial')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_transaction_option', to='order.order')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('accepted', '수락'), ('rejected', '거절'), ('pending', '대기'), ('received', '재료 수령'), ('produced', '제작 완료'), ('deliver', '배송중'), ('end', '거래 완료')], default='pending', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_delivery_information', to='order.order')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_additional_image', to='order.order')),
            ],
            options={
