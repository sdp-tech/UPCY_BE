...
from market.serializers.service_serializers.service_create_retrieve_serializer import ServiceCreateSerializer, ServiceRetrieveSerializer
...
class MarketServiceView(APIView):
    ...
    def get(self, request, **kwargs):
        try:
            market_service = Service.objects.filter(market__market_uuid=kwargs.get('market_uuid')).select_related('market')
    ...
    def post(self, request, **kwargs):
        try:
            ...
            serialized = ServiceCreateSerializer(data=request.data, context={'market': market})
