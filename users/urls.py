...
from users.views.reformer_view.reformer_education_view.reformer_education_create_list_view import ReformerEducationCreateListView
from users.views.reformer_view.reformer_education_view.reformer_education_view import ReformerEducationView
from users.views.token_view.token_view import UserTokenVerifyView, UserTokenRefreshView
...
urlpatterns =[
    ...
    path('/reformer/education', ReformerEducationCreateListView.as_view(), name='reformer_education'),
    path('/reformer/education/<uuid:education_uuid>', ReformerEducationView.as_view(), name='reformer_education_detail'),
    path('/reformer/education/<uuid:education_uuid>/document', ReformerEducationDocumentView.as_view(), name='reformer_education_document'),
