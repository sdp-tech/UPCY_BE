...
class ServiceUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = Service
        fields = ['service_title', 'service_content', 'service_category', 'service_period', 'basic_price', 'max_price']
        extra_kwargs = {
    ...
    def validate(self, attrs):
        ...
        if basic_price is not None and max_price is not None and basic_price > max_price:
    ...
    def update(self, instance, validated_data):
        ...
        instance.service_content = validated_data.get('service_content', instance.service_content)
        instance.service_category = validated_data.get('service_category', instance.service_category)
        instance.service_period = validated_data.get('service_period', instance.service_period)
        instance.save()
        return instance
