...
class MarketUpdateSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.market_introduce = validated_data.get(
            "market_introduce", instance.market_introduce
        )
        instance.market_address = validated_data.get(
            "market_address", instance.market_address
        )
        instance.save()
        return instance
