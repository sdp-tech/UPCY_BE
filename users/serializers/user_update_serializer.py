...
class UserUpdateSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        forbidden_fields = ["email", "password", "agreement_terms", "profile_image",
    ...
    def to_internal_value(self, data):
        ...
        if unknown_fields: # 만약 위에 정의한 4가지 필드 이외의 필드가 존재하는 경우, 에러 발생
            raise ValidationError({field: "This field is not allowed." for field in unknown_fields})
