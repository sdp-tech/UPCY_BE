...
class ServiceOptionCreateListView(APIView):
    ...
    def get(self, request, **kwargs) -> Response:
        try:
            ...
            serializer = ServiceOptionRetrieveSerializer(instance=service.service_option, many=True)
            return Response(
    ...
    def post(self, request, **kwargs) -> Response:
        try:
            ...
            serializer = ServiceOptionCreateSerializer(data=request.data, context={'service': service})
...
class ServiceOptionView(APIView):
    ...
    def put(self, request, **kwargs) -> Response:
        try:
            ...
            serializer = ServiceOptionUpdateSerializer(instance=service_option, data=request.data, partial=True)
            if serializer.is_valid(raise_exception=True):
                serializer.save()
                return Response(
    ...
    def delete(self, request, **kwargs) -> Response:
        ...
        try:
            ...
            return Response(
                data={'message': 'service option deleted'},
                status=status.HTTP_200_OK
            )
        except ServiceOption.DoesNotExist:
            return Response(
